...
| `IconChip` | Icône du registre (`src/lib/icons.tsx`, pack glassmorphism) dans un carré arrondi de couleur douce (catégories, types) | `div` + classes Tailwind, pas de composant shadcn dédié — pattern vu dans `design-system/Products/List/01.png` |
