...
export function TrialsClient({ activeTrials }: { activeTrials: Lead[] }) {
  const endingSoon = activeTrials.filter((t) => {
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        <Card>
          <CardContent className="flex flex-col gap-1">
            ...
            <span className="text-xl font-bold">{activeTrials.length}</span>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex flex-col gap-1">
